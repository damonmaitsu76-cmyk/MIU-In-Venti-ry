...
export function InventoryItemDialog({ item, items, onSaved }) {
  ...
  async function save(event) {
    ...
    if (editMode) { delete payload.item_type; delete payload.unit; delete payload.current_quantity; if (!isPackTracked(item)) delete payload.pack_size }
